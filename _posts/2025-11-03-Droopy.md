...
description: "My first Vulnhub machine: A step-by-step walkthrough for Droopy v0.2 — reconnaissance, foothold with Drupalgeddon2, and root via kernel exploit."
image:
...
|_http-title: Welcome to La fraude fiscale des grandes sociÃ©tÃ©s | La fraud...
...
- `sudo -l` — nothing interesting.
- Checked for SUID binaries — nothing promising.
...
![Result](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZWw4bmE1NmVsdjcybHFhdnBxdnN2YndjdGFxbXVxZDljdHUwZmhrMSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/13hxeOYjoTWtK8/giphy.gif)
...
- Thorough enumeration matters — the `robots.txt`, generator header, and service/version info quickly pointed to Drupal 7.
